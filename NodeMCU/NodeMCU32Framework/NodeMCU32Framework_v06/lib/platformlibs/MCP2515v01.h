...
// MCP2515v01.h
//
// copied from https://github.com/autowp/arduino-mcp2515
//
...
#ifndef _MCP2515V01_H_
#define _MCP2515V01_H_
...
///////////////////////////////////////////////////////////////////////////////
// enable access to MCP2515 with I2C/SPI bridge
//
// 0 = SPI,	just for pre-testing on the NodeMCU32S platform
// 1 = I2C/SPI bridge, regular operation when we have the hardware available

#define I2CSPI_BRIDGE_USED 		1

///////////////////////////////////////////////////////////////////////////////
// SPI speed settings for MCP2515

#define SPI_MCP2515_SPEED	10000000
...
class MCP2515
{
    ...
    private:
		...
		uint8_t i2cBridgeAddress = 0;	// addres of I2C/SPI bridge on I2C bus
		uint8_t spiSlaveAddress  = 0;	// must be 0,1 or 2 when using the I2C/SPI bridge
		#else
		uint8_t spiDeviceNumber  = 0;	// no I2C/SPI bridge, access via SPI bus
		#endif
    ...
    public:
		...
		MCP2515(uint8_t spiDeviceNumber);
		#else
		MCP2515(const uint8_t i2cAddress, const uint8_t spiSlaveNum);	// RASM added: MCP2515 accessed by I2C/SPI bridge
		#endif
		...
		// RASM 20-12-2025, added for debugging
		void printCANError(ERROR errorCode);
};

#endif	// _MCP2515V01_H_
