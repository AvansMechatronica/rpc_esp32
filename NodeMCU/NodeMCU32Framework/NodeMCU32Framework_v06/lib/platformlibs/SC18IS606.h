...
// SC18IS606.cpp
//
// Library for interfacing with the NXP SC18IS606 I2C to SPI bridge
//
// copied from https://github.com/maxgerhardt/SC18IS602B-arduino
//
// Original code was for device = SC18IS602, adapted for SC18IS606
//
...
/* Describes the pin modes a pin of the SC18IS606 can be in */
enum SC18IS606_GPIOPinMode 
{
    SC18IS606_GPIO_MODE_QUASI_BIDIRECTIONAL    = 0B00,
    SC18IS606_GPIO_MODE_PUSH_PULL              = 0B01,
    SC18IS606_GPIO_MODE_INPUT_ONLY             = 0B10,
    SC18IS606_GPIO_MODE_OPEN_DRAIN             = 0B11
};

/* Describes the possible SPI speeds */
enum SC18IS606_SPI_Speed 
{
    SC18IS606_SPICLK_1875_kHz      = 0B00,     // 1.8 MBit/s
    SC18IS606_SPICLK_455_kHz       = 0B01,     // 461 kbit/s
    SC18IS606_SPICLK_115_kHz       = 0B10,     // 115 kbit/s
    SC18IS606_SPICLK_58_kHz        = 0B11      // 58 kbit/s
};

/* Describes the possible SPI modes */
enum SC18IS606_SPI_Mode
{
	SC18IS606_SPIMODE_0 = 0B00, 	// CPOL: 0  CPHA: 0
	SC18IS606_SPIMODE_1 = 0B01, 	// CPOL: 0  CPHA: 1
	SC18IS606_SPIMODE_2 = 0B10, 	// CPOL: 1  CPHA: 0
	SC18IS606_SPIMODE_3 = 0B11		// CPOL: 1  CPHA: 1
};

/* Function IDs */
#define SC18IS606_CONFIG_SPI_CMD 			0xF0
#define SC18IS606_CLEAR_INTERRUPT_CMD 		0xF1
#define SC18IS606_IDLE_CMD 					0xF2
#define SC18IS606_GPIO_WRITE_CMD 			0xF4
#define SC18IS606_GPIO_READ_CMD 			0xF5
#define SC18IS606_GPIO_ENABLE_CMD 			0xF6
#define SC18IS606_GPIO_CONFIGURATION_CMD 	0xF7

#define SC18IS606_DATABUFFER_DEPTH 			1024

class SC18IS606
{
public:
	/* By default instantiate it with no attached RESET pin and a0 to a2 to GND */
	SC18IS606() : SC18IS606(-1, 0, 0, 0) {};

	/* if resetPin = -1 it will be ignored */
	SC18IS606(int resetPin, bool a0, bool a1, bool a2);
	...
	bool setupGPIO(int num, SC18IS606_GPIOPinMode mode);
	...
	bool configureSPI(bool lsbFirst, SC18IS606_SPI_Mode spiMode, SC18IS606_SPI_Speed clockSpeed);
